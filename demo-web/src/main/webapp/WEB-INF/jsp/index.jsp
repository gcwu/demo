				  ...
				  <div class="admin-sidebar am-offcanvas  am-padding-0" id="admin-offcanvas">
				    <div class="am-offcanvas-bar admin-offcanvas-bar">
						...
						<div class="user-box am-hide-sm-only">
	                        ...
	                        <h5><a href="#">${userInfo.loginName }</a> </h5>
	                    ...
	                    <!-- End User -->
						 ...
						 <ul class="am-list admin-sidebar-list">
						    ...
						    <li class="admin-parent">
						      <a class="am-cf" data-am-collapse="{target: '#collapse-nav${menu.id}'}">
						      <span class="am-icon-table"></span>${menu.name} <span class="am-icon-angle-right am-fr am-margin-right"></span>
						      </a>
						      <c:if test="${not empty menu.childMenus }">
						      <c:forEach items="${menu.childMenus }" var="childMenu">
						      <ul class="am-list am-collapse admin-sidebar-sub am-in" id="collapse-nav${menu.id}">
						        <li><a href="${childMenu.url }" class="am-cf"> ${childMenu.name }</span></a></li>
						      </ul>
						      </c:forEach>
						      </c:if>
						    </li>
